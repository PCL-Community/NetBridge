 ...
 * 支持集精确比对，不支持的协议视同该传输未宣告。未来新传输或破坏性 演进通过新增版本串表达，不做兼容回退。
 */
public final class TransportProtocol {
     ...
     */
    public static boolean isSupported(@Nullable String protocol) {
        return protocol != null
                && SUPPORTED.contains(protocol.trim().toLowerCase(Locale.ROOT));
    }
